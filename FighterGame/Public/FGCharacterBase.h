...
protected:
	...
	UFUNCTION(BlueprintCallable)
	void TakeDamage(float DamageAmount, float stunTime, float blockStunTime, float pushBackAmount, float launchAmount, FVector _hitLocation);
